...
function updateAccount(req,res)
{
	...
	var updateData="update userDetails set firstName='"+firstName+"'"+",lastName= '"+lastName+"'"+",email='"+email+"'"+",password='"+password+"'"+",address='"+address+"'"+",zipCode='"+zipCode+"'"+",city='"+city+"'"+",state='"+state+"'"+",accountDetails='"+accountDetails+"'"+"where ssn="+"'"+ssn+"'";
